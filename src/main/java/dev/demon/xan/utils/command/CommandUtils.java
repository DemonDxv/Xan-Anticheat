package dev.demon.xan.utils.command;
...
public class CommandUtils {
    ...
    public static void registerCommand(dev.demon.xan.impl.command.Command commandObject) {
        try {
    ...
    public static void unRegisterBukkitCommand(dev.demon.xan.impl.command.Command commandObject) {
        try {
